...
function create_post_type() {
  register_post_type( 'produit',
    array(
        'supports' => array('comments', 'author','editor', 'thumbnail', 'title'),
      'labels' => array(
        'name' => __( 'Room' ),
...
register_taxonomy( 'Type', 'Description', 'image', array( 'hierarchical' => true, 'label' => 'Couleur', 'query_var' => true, 'rewrite' => true ) );
}
?>
